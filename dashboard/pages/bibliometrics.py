...
layout = html.Div([
    help_section("Industry & Bibliometrics", [
        ...
        "WHY THIS MATTERS FOR THE PAPER'S THESIS: The Industry section supports the paper's call (párr. 5) for 'new categories of germicidal substances'. Funding and publications are growing exponentially, but the underlying biology of selective pressure means that more of the same kind of drug development cannot, by itself, reverse the resistance trajectory. The Antimetabolic Solution page elaborates the alternative therapeutic angle the paper proposes.",
